...
{
    public const string EnvironmentVariable = "QUESTIONABLE_FILE_MANAGER_ADB";
    public const string LegacyEnvironmentVariable = "META_QUEST_FILE_MANAGER_ADB";
    ...
    public static string FindOrThrow(string? explicitPath = null) =>
        Find(explicitPath) ?? throw new InvalidOperationException(
            ...
            $"{LegacyEnvironmentVariable} remains accepted as a deprecated compatibility alias.");
